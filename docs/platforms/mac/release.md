...
ditto -c -k --sequesterRsrc --keepParent dist/OpenClaw.app dist/OpenClaw-2026.3.14.zip

# Optional: build a styled DMG for humans (drag to /Applications)
scripts/create-dmg.sh dist/OpenClaw.app dist/OpenClaw-2026.3.14.dmg
...
ditto -c -k --keepParent apps/macos/.build/release/OpenClaw.app.dSYM dist/OpenClaw-2026.3.14.dSYM.zip
```
...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/OpenClaw-2026.3.14.zip https://raw.githubusercontent.com/openclaw/openclaw/main/appcast.xml
```
...
- Upload `OpenClaw-2026.3.14.zip` (and `OpenClaw-2026.3.14.dSYM.zip`) to the GitHub release for tag `v2026.3.14`.
